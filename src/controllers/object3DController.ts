...
import { Object3DQueryParamsType, UploadObject3DData, UploadObject3DSchema } from "../types/Object3DTypes";
...
function getRequestParameters(req: Request): Object3DQueryParamsType {
    let page = 1;
    let pageLimit = 10;
    let searchKeyword = "";
